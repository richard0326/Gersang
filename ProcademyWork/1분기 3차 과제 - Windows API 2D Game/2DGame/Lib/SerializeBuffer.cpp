...
// 넣기.	각 변수 타입마다 모두 만듬.
//////////////////////////////////////////////////////////////////////////
CSerializeBuffer& CSerializeBuffer::operator << (unsigned char uchValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (char chValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (unsigned short ushValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (short shValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (unsigned int uintValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (int iValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (float fValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (unsigned __int64 uint64Value) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (__int64 int64Value) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator << (double dValue) noexcept
{
...
CSerializeBuffer& CSerializeBuffer::operator >> (unsigned int& dwValue) noexcept
{
